...
public class Room {
    ...
    public IntegerProperty numberProperty(){return this.number;}
    ...
    public int getNumberOfPeoples() {return numberOfPeoples.getValue();}
    public void setNumberOfPeoples(int numberOfPeoples) {this.numberOfPeoples.set(numberOfPeoples);}
    public IntegerProperty numberOfPeoplesProperty(){return this.numberOfPeoples;}

    @Column(name = "comfortable")
    public Comfortable getComfortable() {return comfortable.getValue();}
    public void setComfortable(Comfortable comfortable) {this.comfortable.set(comfortable);}
    public ObjectProperty<Comfortable> comfortableProperty(){return this.comfortable;}
    ...
    public StringProperty fullName(){
        return new SimpleStringProperty(getName() + '(' + getNumber() + ')');
    }
}
